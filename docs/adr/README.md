...
| [009](009-nextjs-frontend.md) | Next.js 15 App Router as the sole frontend (vanilla baseline later removed) | Accepted (amended 2026-09-14) | 2026-09-13 |
| [010](010-single-step-network-and-direct-synthesis.md) | Run the agent network in one Inngest step; synthesise with a plain completion | Accepted | 2026-09-14 |
